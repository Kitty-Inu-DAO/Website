                ...
                <section className='px-5 sm:px-10 pt-4 pb-16 rounded-b-lg'>
                    ...
                    <div className='flex'>
                        <div className='flex-1 video-wrapper mt-4'>
                            <div>
                                {hasWindow &&
                                    <video width='100%' height='100%' controls poster="/img/about/kittys_back_poster.webp">
                    ...
                    <div className='flex flex-col md:flex-row gap-10 mb-8 mt-8 items-center'>
                        ...
                        <div className='flex-1 mt-8 md:mt-0'>
                            <div>
                                {hasWindow &&
                                    <video width='100%' height='100%' controls poster="/img/about/kitty_news_poster.webp">
                        ...
                        <div className='flex-1 video-wrapper'>
                            <div>
                                {hasWindow &&
                                    ...
                                    <video width='100%' height='100%' controls poster="/img/about/kitty_dance_poster.webp">
