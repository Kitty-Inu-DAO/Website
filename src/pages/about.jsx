  ...
  return (
    <>
      ...
      <main className='m-auto w-11/12 lg:w-10/12 xl:w-8/12 pb-10'>
        ...
        <h2 className='mt-16 mb-5'>We Govern Stuff</h2>
        <p className='text-white'>
        ...
        <h2 className='mt-16 mb-5'>cat-doge of the interwebz</h2>
        <p className='text-white'>
        ...
        <h2 className='mt-16 mb-5'>Stacks on Deck</h2>
        <p className='text-white'>
        ...
        <h2 className='mt-16 mb-5'>Kitty next shib</h2>
        <p className='text-white'>
