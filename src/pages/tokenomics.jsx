        ...
        <main className='m-auto w-11/12 lg:w-10/12 xl:w-8/12 bg-sky-800/30 px-10 pt-4 pb-16 rounded-b-lg' style={{ backdropFilter: 'blur(20px)' }}>
          ...
          <div className='flex flex-col items-center justify-center'>
            <div className='mt-6 md:flex md:items-center text-center gap-x-10'>
              <div className="flex content-center justify-center">Token Ticker: <img src='/img/buy/kitty_icon.svg' className='mx-2 w-6 h-6'></img> $kitty</div>
              <div className="flex content-center justify-center mt-4 md:mt-0">L1 Chain: Ethereum Network</div>
            </div>
            <button className='tokenomics-buttons disable mt-12 mb-5 flex items-center cursor-text shadow'>
          ...
          <h2 className='mt-16 text-center'>Token Allocation</h2>
